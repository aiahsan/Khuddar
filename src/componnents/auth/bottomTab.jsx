...
state={
  ...
  componentDidMount(){
    ...
    this.setState({
      ...
      iconColor:this.props.iconColor?this.props.iconColor:'#7c967b',
...
<View style={{position:'absolute',top:off}}>
      ...
      height:100}}>
       ...
       <Animated.View style={{position:'absolute',bottom:0,left:navrr}}>
          ...
          height:45,
          elevation:1,
          borderRadius:RFValue(40)}}></View>


        <View style={{backgroundColor:'white',position:'absolute',
        bottom:0+yoffset,
        right:width>400?RFValue(100):Platform.OS==='ios'?RFValue(104):RFValue(119.60),
        width:width,
        height:100,
      ...
      height:100,
        ...
        <View style={{backgroundColor:'white',position:'absolute',
      bottom:0+yoffset,
      right:Platform.OS==='ios'?-RFPercentage(45.6):width>400?-RFValue(355):-RFPercentage(50.2),
      width:width,
      height:100,
        borderRadius:40
        }}></View>
...
<View style={{position:'absolute',bottom:-20,width:width,height:100,flexDirection:'row',justifyContent:'space-around',paddingVertical:20}}>
        ...
        <MaterialCommunityIcons name={this.state.icon2} size={30} color={this.state.iconColor} />
        </Animated.View></TouchableOpacity>
        ...
        <MaterialCommunityIcons name={this.state.icon3} size={30} color={this.state.iconColor} />
          </Animated.View>
    </TouchableOpacity>
        ...
        <MaterialCommunityIcons name={this.state.icon4} size={30} color={this.state.iconColor} />
        </Animated.View>
        </TouchableOpacity>
        ...
        <MaterialCommunityIcons name={this.state.icon5} size={30} color={this.state.iconColor} />
        </Animated.View>
        </TouchableOpacity>
