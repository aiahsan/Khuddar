...
import { addItemToCart, removeItemFromCart,removeSingleCartItem } from '../../../redux/actions/cartActionMethodes';
// import Language from '../../../Localization/Language'
import { repository } from '../../../utiles/repository';
import LottieView from 'lottie-react-native';
import {emptyCart} from '../../../redux/actions/cartActionMethodes'
import TopDrawer from '../../../componnents/auth/drawer/topDrawer';

import _ from 'lodash'
const MyComponent = () => {
    let [page, setPage] = React.useState({});
    const cartMain=useSelector(x=>x.cart);
    const products=useSelector(x=>x.martItems);
    ...
    const postData = async () => {
        ...
        try
        {
            ...
            const { data, status } = await repository.mart_order({
