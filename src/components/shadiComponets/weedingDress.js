  ...
  const showTimepicker = () => {
    ...
    showMode('time');
      ...
      <View style={{marginLeft:'5%',marginRight:'5%',flex:.2}}>
                  <Text style={{ fontFamily: 'Inter-Black',fontSize:30,color:'#0289a9' ,textAlign:'center'}}>Weeding Dress</Text>
</View>
      <View style={{flex:1.5}}>
        <ScrollView>

<NikkaFiled placeholder="Input Bride Name" label="Bride Name" value={BrideName} setText={setBrideName} />
<NikkaFiled placeholder="Input Banquet Name" label="Banquet Name" value={BanquetName} setText={setBanquetName} />
<NikkaFiled placeholder="Input Banquet Location" label="Banquet Location" value={BanquetLocation} setText={setBanquetLocation} />
