...
export default function(){
  ...
  const [SaloonLocation,setSaloonLocation]=useState('');
  ...
  const showTimepicker = () => {
    ...
    showMode('time');
      ...
      <View style={{marginLeft:'5%',marginRight:'5%',flex:.2}}>
                  <Text style={{ fontFamily: 'Inter-Black',fontSize:30,color:'#0289a9' ,textAlign:'center'}}>Man Saloon</Text>
</View>
      <View style={{flex:1.5}}>
        <ScrollView>

<NikkaFiled placeholder="Input Groom Name" label="Groom Name" value={GroomName} setText={setGroomName} />
<NikkaFiled placeholder="Input Saloon Name" label="Saloon Name" value={SaloonName} setText={setSaloonName} />
<NikkaFiled placeholder="Input Saloon Name" label="Saloon Name" value={SaloonName} setText={setSaloonName} />
<NikkaFiled placeholder="Input Saloon Location" label="Saloon Location" value={SaloonLocation} setText={setSaloonLocation} />
